...
<head>
    ...
    <title>Digi Shop | Manage Products</title>
                    ...
                    <div class="col-12 mb-4" style="background-color:  #CCD1D1;">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <label class="form-lable fs-1 fw-bold text-dark mt-1 mb-3 ms-2">Manage Products</label>
                            </div>
                            <div class="col-12 col-lg-6 mt-4 mb-3">
                                <div class="row">

                                    <div class="col-9">
                                        <input type="text" class="form-control rounded-5" placeholder="Search Products..." id="search_field" />
                                    </div>

                                    <div class="col-3 d-grid">
                                        <button class="btn btn-dark rounded-5" onclick="searchProducts(0);">Search</button>
                                    </div>
